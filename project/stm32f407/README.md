...
GPIO Pin: RST/WAKE/INT PA0/PA8/PB0.
...
ccs811: SCL connected to GPIOB PIN8.
ccs811: SDA connected to GPIOB PIN9.
ccs811: RST connected to GPIOA PIN0.
ccs811: WAKE connected to GPIOA PIN8.
ccs811: INT connected to GPIOB PIN0.
```
...
ccs811: set raw data 0xF6F7.
ccs811: check environment data ok.
ccs811: ccs811_set_eco2_threshold test.
ccs811: set raw data 0x934B.
ccs811: set hysteresis 0xB8.
...
ccs811: set environment humidity 16.00%.
ccs811: check environment humidity 16.00%.
ccs811: ccs811_environment_temperature_convert_to_register/ccs811_environment_temperature_convert_to_data test.
ccs811: set environment temperature 8.30C.
ccs811: check environment temperature 8.30C.
...
ccs811: raw is 0x1D92.
ccs811: ua is 7uA.
ccs811: adc is 0.65V.
ccs811: raw is 0x1DA1.
ccs811: ua is 7uA.
ccs811: adc is 0.67V.
ccs811: raw is 0x1DAE.
ccs811: ua is 7uA.
ccs811: adc is 0.69V.
...
```shell
ccs811 -t update --addr=0 --bin=0:ccs811_firmware_app_v2.0.1.bin
...
```
```shell
ccs811 -e update --addr=0 --bin=0:ccs811_firmware_app_v2.0.1.bin
